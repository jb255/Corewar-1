...
/*   Updated: 2016/12/20 16:58:48 by vlancien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					set_process(t_env *e, int process_nb,
						int x, int creator);
int						get_first_ld(t_env *e, t_type_func list,
						int *error, int xproc);
...
void					write_from_x(t_env *e, int from,
						int data, int octet);
...
int						get_xorandor_arg(t_type_a list, t_env *e,
						int xproc, int *place);
int						reg_funcheck_and(t_env *e, int xproc, int place);
int						get_i0_func_and(t_type_func list, t_env *e,
						int xproc, int *place);
int						get_i1_func_and(t_type_func list, t_env *e,
						int xproc, int *place);
int						get_i02_func_and(t_type_func list, t_env *e,
						int xproc, int *place);
int						get_i1_2_func_and(t_type_func list, t_env *e,
						int xproc, int *place);
void					write_tab(void);
